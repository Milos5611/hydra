...
export function setActionTouchTapCallback( callback ) {
    return {
        [TYPE_KEY]: SET_ACTION_TOUCH_TAP_CALLBACK,
        [ACTION_TOUCH_TAP_CALLBACK]: callback
    };
}
...
export function actionTouchTapCallback() {
    return ( dispatch, getState ) => {
        dispatch(getState().notification[ ACTION_TOUCH_TAP_CALLBACK ]());
    };
}
...
export function showNotification( messageNode = "", actionNode = "", requestCloseCallback = closeNotification, actionTouchTapCallback = closeNotification, duration = DEFAULT_DURATION ) {
    ...
    return ( dispatch ) => {
        ...
        dispatch(setActionTouchTapCallback(actionTouchTapCallback));
